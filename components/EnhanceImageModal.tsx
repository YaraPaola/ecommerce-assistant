                ...
                <div className="flex-grow p-6 grid grid-cols-1 lg:grid-cols-3 gap-6 overflow-y-auto min-h-0">
                    ...
                    <div className="lg:col-span-1 space-y-4">
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-2 max-h-64 overflow-y-auto border rounded p-2 bg-gray-50">
                                {backgroundPresets.map(preset => (
                                    <button key={preset.name} onClick={() => setCustomPrompt(preset.prompt)}
                                        className={`px-3 py-2 text-sm font-medium rounded-lg transition-colors text-left ${customPrompt === preset.prompt ? 'bg-primary-accent text-white border-transparent' : 'bg-white text-gray-700 hover:bg-gray-100 border border-gray-200'}`}>
                                        {preset.name}
                                    </button>
                                ))}
                            </div>
                        ...
                        <div>
                            ...
                            <textarea id="custom-prompt" rows={5} value={customPrompt}
